...
DISTRACTION_COOLDOWN = 1.0  # seconds

def eye_aspect_ratio(landmarks, eye_points, image_w, image_h, frame=None):
...
def show_status(frame, distraction, image_w):
...
def main():
    global distraction, last_distraction_time
        ...
        while True:
            ...
            if results.multi_face_landmarks:
                ...
                for face_landmarks in results.multi_face_landmarks:
                    # Removed drawing of landmarks and contours
                    ...
                    # Distraction logic with cooldown
                    if smooth_score < 40:
                        now = time.time()
                        if now - last_distraction_time > DISTRACTION_COOLDOWN:
                            distraction += 1
            ...
            cv2.putText(frame, f"FPS: {avg_fps:.1f}", (image_w - 120, 30),
                        cv2.FONT_HERSHEY_SIMPLEX, 0.7, (200, 200, 0), 2)

            show_status(frame, distraction, image_w)
